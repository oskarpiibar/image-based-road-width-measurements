...
#
# csv_path = r"C:\Program Files (x86)\Steam\steamapps\common\assettocorsa\apps\python\image_capture\data\17_25_20_16_06_2025.csv"
# image_folder = r"C:\Program Files (x86)\Steam\steamapps\common\assettocorsa\apps\python\image_capture\images_17_25_20_16_06_2025"
#
# df = pd.read_csv(csv_path)
# valid_filenames = set(df["image_filename"].dropna().astype(str))
#
...
#
# # Optionally:
# # print("\nMissing from folder:", missing_in_folder)
# # print("\nExtra in folder:", extra_in_folder)
